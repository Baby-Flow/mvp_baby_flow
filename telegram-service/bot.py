    ...
    try:
        ...
        if response.status_code == 404:
            ...
            await message.answer(
                f"👋 Привет, {first_name}!\n\n"
                "Я помогу вести дневник развития вашего малыша.\n"
                "Просто пишите мне обычными словами, например:\n"
                "• уснул\n"
                "• проснулся\n"
                "• покормила 200мл\n"
                "• гуляем в парке\n\n"
                "Сначала добавьте ребенка командой:\n"
...
/today - активности за сегодня
/help - эта справка

*Как записывать активности:*
Просто пишите обычным языком:
• "уснул" - начало сна
• "проснулся" - конец сна
• "покормила 200мл" - кормление
• "гуляем в парке" - прогулка

*Примеры:*
• уснул в 14:30
• проснулся только что
• покормила грудью 15 минут
• покакал 5 минут назад
"""
